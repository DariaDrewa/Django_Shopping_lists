...
from .views import (ProductsListView, ShoppingListView, ShoppingListDetails, Main, ShoppingListCreate,
                    shopping_list_change, shopping_list_delete,
                    product_create, product_change, product_delete)
